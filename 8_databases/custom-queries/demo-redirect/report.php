...
<html>
    ...
    <body>
        ...
        */
        ...
        // Adjust sorting based on given POST variable.
        if ($_POST['sortBy'] == 'name') {
            $sortBy = 'ORDER BY hscName ASC';
        } else if ($_POST['sortBy'] == 'game') {
            $sortBy = 'ORDER BY hscGame ASC';
        } else if ($_POST['sortBy'] == 'score') {
            $sortBy = 'ORDER BY hscScore DESC';
        } else {
            $sortBy = ';'
        }
